...
// FOR EACH LOOP
// inventory.forEach( car_models => carModels.push(car_models.car_model));
// carModelsSorted = carModels.sort();

// ES6 Map method.
let mappedModels = inventory.map( car_models => car_models.car_model);
mappedModels = mappedModels.sort();
...
const mapped_car_years = inventory.map(carYears => carYears.car_year ); 
console.log(mapped_car_years);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
// let oldCars = [];

const oldCars = mapped_car_years.filter( carYears => carYears < 2000);
...
let BMWAndAudi = inventory.filter(cars =>  cars.car_make === "BMW" || cars.car_make === "Audi");
